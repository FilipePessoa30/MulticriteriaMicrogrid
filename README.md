...
- As emissões são aproximadas; sem consumo/geração a diesel, não há CO₂ real. Se obtiver esses dados, substitua a proxy.
- Os resultados refletem apenas as alternativas do REopt (PV/bateria/diesel). Para comparar cenários C1–C4 (solar/eólica/híbrido/rede), é preciso gerar/fornecer esses cenários com custo/emissões/confiabilidade e rerodar os métodos.
- Sensibilidade já cobre v do VIKOR e perfis de pesos; Econ/Resilientes estáveis, divergência no Sustentável pelo VIKOR.
